...
$sql_query = "SELECT * FROM antriloketp LIMIT 1";
...
<body onload=display_ct();>
        ...
        <table class="table table-bordered">
            <thead>
                <tr style="background-color: grey; color: white">
                    ...
                    <th style="width: 165px; text-align: center">Nama</th>
    ...
    <a href="inputLoketBLP.php" style="margin: auto; margin-bottom: 75px;display:flex; justify-content: center; align-items: center"> <button class="btn btn-primary"><strong>INPUT LOKET</strong></button></a>
